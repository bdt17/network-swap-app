...
ActiveRecord::Schema[8.1].define(version: 2026_02_24_215505) do
  ...
  create_table "drone_fleets", force: :cascade do |t|
    ...
    t.float "max_operational_range_km"
    t.string "name"
  ...
  create_table "drones", force: :cascade do |t|
    ...
    t.string "status"
    t.datetime "updated_at", null: false
    t.index ["fleet_id"], name: "index_drones_on_fleet_id"
  end
